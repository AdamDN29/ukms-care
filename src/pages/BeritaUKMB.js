...
export default function BeritaUKMB () {
    return (
	<div className='BeritaUKMB_BeritaUKMB'>
		...
		<img className='Rectangle41' src = {ImgAsset.BeritaUKMB_Rectangle41} />
			...
			<div className='Frame363'>
				<div className='NavbarSetelahLogin'>
					...
					<div className='Frame376'>
						<img className='Vector_5' src = {ImgAsset.BeritaUKMB_Vector_5} />
					</div>
				</div>
			</div>
		</div>
