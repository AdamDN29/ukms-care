    ...
    render (){
		...
		<div className='Group309'>
			<div className='Rectangle1'>
			    <img className='image1' src = {ImgAsset.UKMUnpadB_taekwondoremovebgpreview3} />
			    <span className='name1'>M Rafiq Abdillah </span>
                <span className='npm1'>140810190011 </span>
            </div>

            <div className='Rectangle2'>
			    <img className='image2' src = {ImgAsset.UKMUnpadB_taekwondoremovebgpreview3} />
			    <span className='name2'>Chandra Wijaya </span>
                <span className='npm2'>140810190033 </span>
            </div>

            <div className='Rectangle3'>
			    <img className='image3' src = {ImgAsset.UKMUnpadB_taekwondoremovebgpreview3} />
			    <span className='name3'>Bagas Adi Firdaus </span>
                <span className='npm3'>140810190037 </span>
            </div>

            <div className='Rectangle4'>
			    <img className='image4' src = {ImgAsset.UKMUnpadB_taekwondoremovebgpreview3} />
