...
export default function HomepageA_1 () {
    return (
	<div className='HomepageA_1_HomepageA'>
		...
		<Link to='/ukmunpada'>
			<img className='Arrow2' src = {ImgAsset.HomepageA_1_Arrow2} />
		</Link>
		...
		<div className='Group335'>
			<div className='Group326_2'>
				...
				<div className='Group326_3'>
					<span className='InformasiterbaruseputarUKMfavoritkamu'>Informasi terbaru seputar UKM favorit kamu</span>
				</div>
				<div className='Group325_2'>
					<span className='LangsungdaftarkeUKMfavoritkamutanparibet'>Langsung daftar ke UKM favorit kamu tanpa ribet </span>
				</div>
			</div>
		...
		<div className='NavbarSetelahLogin'>
			...
			<Link to='/beritaukmb'>
				<div className='Frame238'>
					...
					<span className='BeritaUKM_2'>Berita UKM</span>
				</div>
			</Link>
			<div className='Frame376'>
				<Link to='/profileuser'>
					<img className='Vector_11' src = {ImgAsset.HomepageA_1_Vector_11} />
				</Link>
			</div>
		</div>
	</div>
